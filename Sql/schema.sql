...
IF (SELECT NAME FROM sys.databases WHERE NAME = 'NetTopologySuiteDemo') IS NOT NULL
...
VALUES
    (1, 'Los Angeles', geography::Point(34.0522, -118.2437, @SRID), 1),
...
VALUES
    (1, 'Hollywood Sign', 1, geography::Point(34.1341, -118.3215, @SRID)),
